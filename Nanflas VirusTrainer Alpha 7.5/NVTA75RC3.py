...
2024-8-7  --CS2B Studio
NVT Alpha 6.0807 PyVer
-重构了UI
-增加了一些功能

2024-8-13 --CS2B Studio
NVT Alpha 6 PyVer
-优化了UI
-支持了保存设置项
-支持了在线更新
        ...
        while True:
            ...
            match(option):
                ...
                case "BackgroundProt":
                    ...
                    print(KBPSSettingCommand)
                case "h" :
                    print("--------NFLS Virus Trainer Alpha 7.5 RC2 CommandLine Mode Help--------- ")
                    print("      Commands      |                       Uses                        ")
                    print("----------------------------------------------------------------------- ")
