...
class KVTIEditor(ttk.Frame):
    def __init__(self, master):
        ...
        self.welcome_label = ttk.Label(self, text="Welcome to the Editor for KVTI Files!", font=("Helvetica", 16))
    ...
    def new_file(self):
        """Initialize a new empty KVTI file structure and show the 'Add Key-Value Pair' button."""
        self.data.clear()
    ...
    def open_kvtie(self):
        path = filedialog.askopenfilename(filetypes=[("Encrypted KVTI files", "*.kvtie")])
        if path:
